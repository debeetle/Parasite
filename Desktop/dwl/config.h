...
/*static int gaps            = 1;  horiz inner gap between windows */
static const unsigned int gappx            = 8; /* horiz inner gap between windows */
static const float rootcolor[]             = COLOR(0x282a36ff);
static const float bordercolor[]           = COLOR(0x777777ff);
static const float focuscolor[]            = COLOR(0xfe640bff);
...
static const Key keys[] = {
	...
	/*{ MODKEY,                    XKB_KEY_space,          setlayout,      {.v = &layouts[3]} },*/
	...
	// { MODKEY|WLR_MODIFIER_SHIFT|WLR_MODIFIER_LOGO, XKB_KEY_Escape,          quit,           {0} },
